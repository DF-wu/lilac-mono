...
比較基準為 2026-09-13 的 `main`：本 fork 已包含 upstream commit [`4ed0aafc`](https://github.com/stanley2058/lilac-mono/commit/4ed0aafc914bcfe911924a18e13a01e2f4fbfd60)，並在其上保留下列功能與維運修改。
