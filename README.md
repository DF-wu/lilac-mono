...
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------- |
| Telegram surface                | DMs, groups, forum topics, streaming HTML replies, cancellation, reactions, command menu, inbound photos/documents, outbound attachments, workflow cards, and same-surface tools | Disabled by default; long polling only; inbound bytes are omitted from persisted transcripts      |
