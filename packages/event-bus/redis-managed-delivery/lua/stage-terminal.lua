...
if redis.call("HGET", KEYS[2], "state") ~= "terminal-preparing" or redis.call("HGET", KEYS[2], "token") ~= ARGV[2]
...
redis.call("HSET", KEYS[2], "state", "dead-letter-pending", "terminal_id", ARGV[6],
  "terminal_record_key", ARGV[7], "terminal_record_value", ARGV[8], "terminal_has_evidence", ARGV[9],
  "terminal_evidence_key", ARGV[10], "terminal_evidence_value", ARGV[11], "terminal_index_key", ARGV[12],
  "terminal_index_fields", ARGV[13], "terminal_index_score", ARGV[14], "terminal_index_max_len", ARGV[15],
  "terminal_ttl_seconds", ARGV[16])
redis.call("HDEL", KEYS[2], "terminal_reason")
