      ...
      try {
        ...
        while (true) {
          ...
          try {
            ...
            // Some OpenAI-compatible providers report a non-standard finish
            // reason (for example, `other`) even when the response contains
            // valid local tool calls. The parsed calls are authoritative: an
