...
describe("WorkspaceHistoryStore", () => {
  ...
  // test-wait-justification: this crash-recovery integration test launches four child Bun processes that each initialize and restore a workspace.
  ...
  // test-wait-justification: this crash-recovery integration test launches three child Bun processes that each initialize and restore a workspace.
