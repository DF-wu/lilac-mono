...
const discordEmbedImageSchema = z.object({ url: optionalNonEmptyStringSchema }).loose();
const discordEmbedFooterSchema = z.object({ text: optionalNonEmptyStringSchema }).loose();
