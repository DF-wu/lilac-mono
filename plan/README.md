...
- [Native Lilac surface and first-party clients](native-surface.md): active, Stage 0 contracts and technical proofs. [Implementation progress](native-surface-progress.md).
